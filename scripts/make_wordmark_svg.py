...
FONT_PATH = os.environ.get("WORDMARK_FONT", r"C:\Windows\Fonts\GOTHICB.TTF")
...
TEXT = os.environ.get("WORDMARK_TEXT", "ADA")
...
def emit(frames, mode, out, dur, reveal):
    ...
    p.append(f'<text x="{canvas_w/2:.0f}" y="{TITLEBAR_H/2 + 4:.0f}" fill="{TITLE_TEXT}" '
             f'font-size="11.5" text-anchor="middle">ada@github: ~$ ./wordmark.sh --3d</text>')
